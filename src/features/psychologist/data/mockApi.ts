import type { Consulta } from "../services/appointmentService.ts";
...
const mockPacientesDatabase: {
  [id: string]: { name: string; avatarUrl: string };
} = {
  mu3Mo6I0eSSD3aWZdYte: {
    name: "Marcos Vitor",
    avatarUrl: "https://i.pravatar.cc/40?u=marcos",
  },
  "2QZfL6ICZwO6UUMBN14I": {
    name: "Juliana Martins",
    avatarUrl: "https://i.pravatar.cc/40?u=juliana",
  },
};

// MUDANÇA: Adicionado banco de dados de psicólogos
const mockPsicologosDatabase: {
  [id: string]: { name: string; avatarUrl: string };
} = {
  CRsiWje2vKiLsr5fCpxW: {
    name: "Ester Ravette",
    avatarUrl: "https://i.pravatar.cc/40?u=ester",
  },
};
...
export const getPacienteData = (pacienteId: string) => {
  return (
    mockPacientesDatabase[pacienteId] || {
...
export const getPsicologoData = (psicologoId: string) => {
  return (
    mockPsicologosDatabase[psicologoId] || {
      name: "Psicólogo Desconhecido",
      avatarUrl: "https://i.pravatar.cc/40",
    }
  );
};
